...
$(function ()
{
	...
	// Facebook Out
    addContentTweenToElement(TweenMax.to($('#facebook-description'), defaultDuration, {autoAlpha: 0, ease:getDefaultEasing(true)}), '#facebook-description');
	
	// Stream In
	addContentTweenToElement(TweenMax.from($('#stream-description'), defaultDuration, {css:{autoAlpha: 0, 'left': '-100%'}, ease:getDefaultEasing(true)}), '#stream');
	addContentTweenToElement(TweenMax.from($('#stream-hero'), defaultDuration, {css:{autoAlpha: 0, 'left': '100%'}, ease:getDefaultEasing(true)}), '#stream')
